...
"""Centralized harness registry -- single source of truth for per-harness data.
...
When adding a new harness, add its entry here and everything else
(``VALID_HARNESSES``, ``HARNESS_CAPABILITIES``, scope helpers, shim targets)
